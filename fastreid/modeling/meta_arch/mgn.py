    ...
    def from_config(cls, cfg):
        ...
        res_p_conv5 = nn.Sequential(
            Bottleneck(
                ...
                False,
                with_se,
                downsample=nn.Sequential(nn.Conv2d(1024, 2048, 1, bias=False), get_norm(bn_norm, 2048)),
            ),
    ...
    def losses(
        ...
        if "CrossEntropyLoss" in loss_names:
            ...
            loss_dict["loss_cls_b1"] = (
                cross_entropy_loss(b1_logits, gt_labels, ce_kwargs.get("eps"), ce_kwargs.get("alpha"))
                * ce_kwargs.get("scale")
                * 0.125
            )

            loss_dict["loss_cls_b2"] = (
                cross_entropy_loss(b2_logits, gt_labels, ce_kwargs.get("eps"), ce_kwargs.get("alpha"))
                * ce_kwargs.get("scale")
                * 0.125
            )

            loss_dict["loss_cls_b21"] = (
                cross_entropy_loss(b21_logits, gt_labels, ce_kwargs.get("eps"), ce_kwargs.get("alpha"))
                * ce_kwargs.get("scale")
                * 0.125
            )

            loss_dict["loss_cls_b22"] = (
                cross_entropy_loss(b22_logits, gt_labels, ce_kwargs.get("eps"), ce_kwargs.get("alpha"))
                * ce_kwargs.get("scale")
                * 0.125
            )

            loss_dict["loss_cls_b3"] = (
                cross_entropy_loss(b3_logits, gt_labels, ce_kwargs.get("eps"), ce_kwargs.get("alpha"))
                * ce_kwargs.get("scale")
                * 0.125
            )

            loss_dict["loss_cls_b31"] = (
                cross_entropy_loss(b31_logits, gt_labels, ce_kwargs.get("eps"), ce_kwargs.get("alpha"))
                * ce_kwargs.get("scale")
                * 0.125
            )

            loss_dict["loss_cls_b32"] = (
                cross_entropy_loss(b32_logits, gt_labels, ce_kwargs.get("eps"), ce_kwargs.get("alpha"))
                * ce_kwargs.get("scale")
                * 0.125
            )

            loss_dict["loss_cls_b33"] = (
                cross_entropy_loss(b33_logits, gt_labels, ce_kwargs.get("eps"), ce_kwargs.get("alpha"))
                * ce_kwargs.get("scale")
                * 0.125
            )
