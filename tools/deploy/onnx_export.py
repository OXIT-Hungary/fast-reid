...
def get_parser():
    ...
    parser.add_argument("--output", default="onnx_model", help="path to save converted onnx model")
    parser.add_argument("--batch-size", default=1, type=int, help="the maximum batch size of onnx runtime")
    parser.add_argument(
        "--opts",
