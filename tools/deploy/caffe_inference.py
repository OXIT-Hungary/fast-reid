...
def get_parser():
    ...
    parser.add_argument("--model-def", default="logs/test_caffe/baseline_R50.prototxt", help="caffe model prototxt")
    parser.add_argument(
        "--model-weights",
    ...
    parser.add_argument("--output", default="caffe_output", help="path to save converted caffe model")
